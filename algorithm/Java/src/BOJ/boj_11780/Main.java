...
LinkedList면 좋겠다. O(1) *=> O(N)이었다. O(1)은 *MOVE 연산

어차피 새 LinkedList<Integer>를 만들어야 하는거면 또 O(N)이다.
그러면 그냥 ArrayList쓰는게 빠르겠다..?

LinkedList.addAll(LinkedList) => O(N)
